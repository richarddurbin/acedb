 ...
 * Last edited: May  6 13:37 2003 (edgrif)
 *-------------------------------------------------------------------------
 */

/* $Id: oxhomlist.c,v 1.10 2003-05-06 13:14:02 edgrif Exp $ */
...
static void hlPick (int box, double x_unused, double y_unused, int modifier_unused) ;
static void hlSelect (OX ox, int box) ;
static void hlFollow (OX ox) ;
static void showTree (void) ;
static void hlKeyboard (int k, int modifier_unused) ;
