 ...
 * HISTORY:
 * Last edited: May  6 13:39 2003 (edgrif)
 *	- change NULL's to 0's to please MS Visual C++ compiler
 * Created: January 1995
 *-------------------------------------------------------------------
 */

/* $Id: specg.c,v 1.14 2003-05-06 13:14:04 edgrif Exp $ */
...
int pointOrder (void *a, void *b) ;
static void specPick (int box, double x_unused, double y_unused, int modifier_unused) ; 
