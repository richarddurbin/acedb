 ...
 * HISTORY:
 * Last edited: May  6 13:38 2003 (edgrif)
...
/* $Id: pairmapdisp.c,v 1.14 2003-05-06 13:14:03 edgrif Exp $ */
...
static void pairMapPick (int box, double x_unused, double y_unused, int modifier_unused) ; 
