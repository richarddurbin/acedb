 ...
 * Exported functions:
 * HISTORY:
 * Last edited: Sep  2 14:10 2003 (edgrif)
...
/* $Id: fmapstatus.c,v 1.16 2003-09-02 13:37:18 edgrif Exp $ */
...
static void symbolicStatus (FeatureMap look, float offset)
  {
  int i, j, click, dx, dy ;
