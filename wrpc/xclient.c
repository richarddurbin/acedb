 ...
 * HISTORY:
 * Last edited: Sep 21 14:05 2000 (edgrif)
 * * Apr 26 11:47 2000 (edgrif): Fix horrible bug in xClientSave with
 *              mix up of malloc/free & strnew/messfree.
 * Created: Tue Jun 28 14:13:30 1994 (mieg)
 * CVS info:   $Id: xclient.c,v 1.43 2000-09-21 13:17:54 edgrif Exp $
 *-------------------------------------------------------------------
 */
