/*  Last edited: May 12 22:33 1996 (rd) */
...
*/
/* Above notice from README in Tom Boutell's distribution */
/* All changes for ACEDB are marked by a comment containing ACEDB */

/* $Id: gd.c,v 1.5 1996-05-12 22:35:09 rd Exp $ */
...
#include <string.h>
#include <stdlib.h>
#include "../wgd/gd.h"		/* ACEDB ../wgd */
#include "../wgd/mtables.c"	/* ACEDB ../wgd */

static void gdImageBrushApply(/* gdImagePtr im, int x, int y */);
static void gdImageTileApply(/* gdImagePtr im, int x, int y */);
static int gdCompareInt(const void *ap, const void *bp) ;
	...
	int c;
{
  ...
  /* ACEDB added ,c to end of next line - bug in Boutell's code from Decoux */
	...
	int noOfPixels;
{
	...
	im->style = (int *)	/* ACEDB - was unsigned int* - incompatible with gd.h */
