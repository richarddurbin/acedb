 ...
 * * Feb  8 14:28 1999 (edgrif): Add #ifdef ACEDB5.
 * Created: Wed Feb 25 1997
 *-------------------------------------------------------------------
 */

/* $Id: acache.c,v 1.10 1999-11-24 14:25:50 mieg Exp $ */
...
int aCacheSaveAll(void)
{
  ...
  /* this verif fails because i think of duplicateSessionObj
     which does a direct manipulation of the cache
     but i am not really sure why
     the crash shows only if i read models in session > 1
  if (total != totalCache)
