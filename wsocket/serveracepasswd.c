 ...
 * HISTORY:
 * Last edited: Mar 21 11:28 2003 (edgrif)
 * Created: Mon Mar  6 21:40:26 2000 (edgrif)
 * CVS info:   $Id: serveracepasswd.c,v 1.11 2003-03-21 15:50:52 edgrif Exp $
 *-------------------------------------------------------------------
 */
			     ...
			     ClientAccessStatus *status_out)
{
  ...
  if (group == ACEUSER_ADMIN)
      ...
      else
	{
	  ...
	  /* set.                                                            */
	  if (checkForServerConfigValue(server, ACESERV_NODOMAINRESOLVE, NULL) == FALSE)
	    {
	      char *dotted, *plain ;
