 ...
 *
 * SCCS: $Id: aqlparse.y,v 1.37 2009-05-01 09:02:57 edgrif Exp $
 * Description: yacc grammar for AQL
 * Exported functions:
 *              aqlParse()
 * HISTORY:
 * Last edited: May  1 10:02 2009 (edgrif)
...
void aqlParse (AQL aql)
{
  ...
  /* I have def'd this out because it now causes the call to yyparse() to crash in the system
   * function fileno(), probably this is now redundant but may be dependent on linux level. */
